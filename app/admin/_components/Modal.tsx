...
const Modal = ({ show, onClose, onConfirm, nums }: any) => {
  ...
  return (
    <button
      className="fixed inset-0 bg-foreground-500 bg-opacity-75 flex items-center justify-center z-50"
      onClick={onClose}
    >
      <button
        className="bg-foreground-300 p-6 rounded-lg shadow-lg w-80"
